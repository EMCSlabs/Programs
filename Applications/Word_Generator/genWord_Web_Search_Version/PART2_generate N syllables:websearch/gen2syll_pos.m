function [allW2, realW2, nonW2] = gen2syll_pos(initov, initvc, initco, finov, finvc,r_ov1,r_vc1,r_co1,r_ov2,r_vc2)
...
%
% Input
%     initov: table of onset-vowel sequence in the initial position/frequency/probability 
%     initvc: table of vowel-coda sequence in the initial position/frequency/probability
%     initco: table of coda-onset(of the following syllable) sequence in the initial position/frequency/probability
%     finov: table of onset-vowel sequence in the final position/frequency/probability
%     finvc: table of vowel-coda sequence in the final position/frequency/probability
